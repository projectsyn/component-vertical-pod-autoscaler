...
See https://github.com/kubernetes/autoscaler/blob/30aea661ffc8e9aabf3af7eceded34f4be820f79/vertical-pod-autoscaler/docs/flags.md#what-are-the-parameters-to-vpa-recommender[FAQ] for possible options.
